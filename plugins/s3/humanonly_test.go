...
// What moves a whole bucket is for the person at the terminal, and the
...
func TestMovingAWholeBucketIsNeverATool(t *testing.T) {
	want := map[string]bool{
		"s3.bucket.download": true,
		"s3.bucket.upload":   true,
	}
	seen := 0
