...
// SDK in this working tree — which is the point: a change that breaks a
// plugin author breaks this build, in the same commit that made it.
module github.com/this-is-tobi/rule-them-all/plugins/pg
