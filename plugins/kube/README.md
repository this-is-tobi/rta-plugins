...
| dashboard  | not on the automatic dashboard — it declines to run unasked; \`rta dashboard add kube.context.list\`, or + on it in the TUI, puts it there, re-run every few seconds |
